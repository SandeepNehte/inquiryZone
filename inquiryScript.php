...
// PHP contact submit part1 code here start ----->
$name = $_POST['name'];
$email = $_POST['email'];
$mobile =  $_POST['mobile'];
...
$query = "INSERT INTO `admissionenquirytbl`(`name`, `email`, `mobile`, `message`) VALUES ('$name', '$email', '$mobile', '$message')";
?>
<!------------------------- PHP contact submit part1 code here end ----->
<!DOCTYPE html>
<html lang="en">
    <head>
        <title>Enquiry</title>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-8">
                                            <div class="page-header-title">
                                                <h5 class="m-b-10">Enquiry Page</h5>
                                                <p class="m-b-0">Please Feel Free to Ask Any Query</p>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <ul class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item"><a href="#!">User Enquery Page</a>
                                            </li>
                                            <li class="breadcrumb-item"><a href="#!">Form A</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                            ...
                                            <div class="card o-visible">
                                                ...
                                                <div class="card-block tooltip-icon button-list">
                                                    <div class="card-body">
                                                        ...
                                                        <!--------- PHP Script for Contact form Submission part 2 start ------->
                                                        <?php
                                                        ...
                                                        echo "Error..!!!";
                                                        ?>
                                                        <!--------- PHP Script for Contact form Submission part 2 end------->
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card button-page o-visible">
                                                    ...
                                                    <div class="card-block tooltip-icon button-list">
                                                        <div class="input-group">
                                                            ...
                                                            <i class="icofont icofont-user-alt-3"></i></label></span>
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="card o-visible">
                                                    ...
                                                    <div class="card-block tooltip-pop button-list">
                                                        ...
                                                        <button class="btn btn-primary" type="submit" class="btn btn-primary waves-effect waves-light m-r-20" data-toggle="tooltip" data-placement="right" title="submit">Submit
                                                        </button>
                                                    </form>
                                                </div>
                                            </div>
