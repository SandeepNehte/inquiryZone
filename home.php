                ...
                <div class="pcoded-wrapper">
                    <nav class="pcoded-navbar">
                            ...
                            <div class="pcoded-inner-navbar main-menu">
                                ...
                                <div class="pcoded-navigation-label">Enquiry Form</div>
                                <ul class="pcoded-item pcoded-left-item">
                                    <li class="">
                                        <a href="enquiry.php" class="waves-effect waves-dark">
                                ...
                                <ul class="pcoded-item pcoded-left-item">
                                    <li class="pcoded-hasmenu ">
                                        ...
                                        <ul class="pcoded-submenu">
                                            <li class="">
                                                <a href="Signin.php" class="waves-effect waves-dark">
                                            ...
                                            <li class="">
                                                <a href="enquiry.php" class="waves-effect waves-dark">
                                                    ...
                                                    <span class="pcoded-mtext">Enquiry Page</span>
                                                    <span class="pcoded-mcaret"></span>
                                                </a>
                                            </li>
                                        </ul>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">Welcome to Testing World</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                                            ...
                                                            <table class="table table-hover m-b-0 without-header">
                                                                <tbody>
                                                                        ...
                                                                        <td>
                                                                            <div class="d-inline-block align-middle">
                                                                                ...
                                                                                <div class="d-inline-block">
                                                                                    <h6>Sandeep Nehte</h6>
                                                                                    <p class="text-muted m-b-0">Test Analyst, IN</p>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-right">
                                                                            <h6 class="f-w-700">$56.051<i class="fas fa-level-up-alt text-c-green m-l-10"></i></h6>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                        ...
                                                                        <td class="text-right">
                                                                            <h6 class="f-w-700">$48.011<i class="fas fa-level-up-alt text-c-green m-l-10"></i></h6>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
